...
##  This slightly modified version of program creates completion for all aliases
##  in environment.

##  Origin @: https://github.com/cykerway/complete-alias

##  Modified by kromanow94
##  ============================================================================
...
readarray aliases <<< $(alias | awk -F'[ =]' '{print $2}')
